...
export const routes: Routes = [
	...
	{ path: 'signup', component: SignupComponent },
	{
		...
		children: [
			{ path: 'dashboard', component: DashboardComponent, canActivate: [roleGuard], data: { roles: ['buyer', 'producteur', 'technicien', 'cooperative', 'ong', 'etat'] } },
			{ path: 'profile', component: ProfileComponent, canActivate: [roleGuard], data: { roles: ['buyer', 'producteur', 'technicien', 'cooperative', 'ong', 'etat', 'admin'] } },
			...
			{ path: 'planning', component: PlanningComponent, canActivate: [roleGuard], data: { roles: ['producteur', 'cooperative'] } },
			{ path: 'market', component: MarketComponent, canActivate: [roleGuard], data: { roles: ['buyer', 'producteur', 'cooperative'] } },
